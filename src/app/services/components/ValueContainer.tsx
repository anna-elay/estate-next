    ...
    <div className="container mx-auto">
      <section id='property' className='scroll-mt-25'>
        <div className="flex flex-col items-start justify-center  pb-15px pt-22.5">
          ...
          <h2 className="text-[38px] pb-2.5">Unlock Property Value</h2>
          <p>
            ...
            to maximize the value of you property, ensuring you get the best deal
            possible. Explore the categories below see how we can help you at
            every step of you selling journey.
          </p>
        </div>
      </section>
