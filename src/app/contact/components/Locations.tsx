...
const Locations = () => {
  return (
    <div className="py-30 container mx-auto">
      ...
      <div className="bg-gray-10 p-2.5 inline-flex gap-2.5 rounded-xl ">
        <button className="btn-gray active hover:bg-gray-09! min-w-40! min-h-16 rounded-[10px]!">
          All
        </button>
        <button className="btn-gray hover:bg-gray-09! min-w-40! min-h-16 rounded-[10px]!">
          Regional
        </button>
        <button className="btn-gray hover:bg-gray-09! min-w-40! min-h-16 rounded-[10px]!">
          Internetional
      ...
      <div className="flex gap-5 pt-10">
        <div className="border border-gray-15 rounded-xl p-12.5">
          ...
          <div className="flex gap-2.5 py-7.5">
          ...
          <button className="btn-purple py-4.5 w-full ">Get Direction</button>
        </div>
        <div className="border border-gray-15 rounded-xl p-12.5">
          <span className="text-[14px]">Main Headquarters</span>
          <h4 className="font-semibold text-[30px] py-3">
