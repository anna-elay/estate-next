...
const StoryContainer = () => {
  return (
    <section id="story" className="scroll-mt-30">
      <div className=" container mx-auto flex flex-col lg:flex-row  gap-10 lg:gap-30 pb-22.5 px-4 lg:px-20">
        <div className="flex flex-col items-start justify-center lg:w-1/2">
          <img className="-m-2.5 pb-1.5" src="/image/Stars.png" alt="Stars" />
          <h2 className="text-[28px] lg:text-[38px] pb-2.5">Our Values</h2>
          <p>
