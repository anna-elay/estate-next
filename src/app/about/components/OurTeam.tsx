  ...
  return (
    <section id="team" className="scroll-mt-45">
      <div className="container mx-auto px-4 lg:px-20">
        ...
        <div className="pt-15 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <div className="  p-6 rounded-xl border border-gray-15 lg:max-w-75">
