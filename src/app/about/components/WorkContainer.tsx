  ...
  return (
    <div className="container mx-auto px-4 lg:px-20">
      <div className="flex flex-col items-start justify-center lg:w-1/2 pb-15px">
        ...
        <h2 className="text-[28px] lg:text-[38px] pb-2.5">Our Achievements</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-5 lg:gap-12.5 pt-15">
        <div className=" p-10 border-4 border-gray-10 inner-border-1 rounded-2.5 rounded-[10px]">
          <h4 className="text-xl lg:text-2xl font-semibold pb-6">
