  ...
  return (
    <div className="flex gap-20 py-30">
      <div className="max-w-110 ">
        <h3 className="text-[38px]">Inquire About Seaside Sereity Villa</h3>
        <p>
      ...
      <div className="grid grid-cols-2 border border-gray-15 rounded-xl p-10 gap-7.5 ">
        ...
        <div className=" row-span-2 flex flex-col col-span-2 ">
        ...
        <div className="flex justify-between pt-7.5 gap-20">
