...
const Negotiation = () => {
  return (
    <div>
      ...
      <h3 className="text-[38px] font-semibold pb-2.5">
      ...
      <div className="pt-15 pb-10">
        <div className="flex items-center bg-gray-10 border border-gray-15 rounded-lg p-[20px_40px]">
          <span className="border-r border-gray-15 pr-4">Note</span>
            ...
            <div className="p-10 border border-gray-15 rounded-xl w-full">
              <div>
                ...
                <div className="flex justify-between">
                  ...
                  <div className="border-l border-gray-15 pl-5">
                    <p>Legal Fees</p>
                    <div className="pt-3">
                      <span className="pr-4 font-semibold text-[20px]">
                        $3,000
                ...
                <div className="flex justify-between">
                  ...
                  <div className="border-l border-gray-15 pl-5 pr-13">
